...
![Without Env Demo](https://github.com/arrterian/nix-env-selector/raw/master/resources/without-env-demo.gif)

As you can see VS Code can't find the GHC compiler. Let's apply
the environment declared in `shell.nix`.

![With Env Demo](https://github.com/arrterian/nix-env-selector/raw/master/resources/with-env-demo.gif)
...
[MIT](https://github.com/arrterian/nix-env-selector/blob/master/LICENSE)
