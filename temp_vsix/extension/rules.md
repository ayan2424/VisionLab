The `extensions/vscode` folder contains code for the "VisionLab Agent" VS Code Extension. Continue is a coding extension which extends IDE functionality with AI.
