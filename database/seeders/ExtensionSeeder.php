...
class ExtensionSeeder extends Seeder
{
    ...
    {
        $extensions = [
            ['name' => 'VisionLab Collab',   'package_identifier' => 'VisionLab.collab',          'version' => '1.0.0', 'description' => 'Real-time collaboration: cursor sharing, live chat, and presence.',      'is_global' => true,  'is_builtin' => true,  'is_active' => true],
            ['name' => 'VisionLabAgent',  'package_identifier' => 'VisionLab.ai-agent',         'version' => '1.0.0', 'description' => 'AI-powered code assistant with CHAT, PLAN, and AGENT modes.',            'is_global' => true,  'is_builtin' => true,  'is_active' => true],
            ['name' => 'Patch Reviewer',       'package_identifier' => 'VisionLab.patch-reviewer',   'version' => '1.0.0', 'description' => 'Diff viewer for AI patch proposals with approval workflow.',             'is_global' => true,  'is_builtin' => true,  'is_active' => true],
