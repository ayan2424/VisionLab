...
export default defineConfig({
  ...
  resolve: {
    // Ensure modules imported from ../core/ resolve from gui/node_modules
    dedupe: ["uri-js", "web-tree-sitter", "uuid"],
    alias: {
      "uri-js": resolve(__dirname, "node_modules/uri-js"),
    },
  },
  build: {
    sourcemap: true,
    ...
    rollupOptions: {
      ...
      // Externalize Node.js builtins that core imports but GUI doesn't need at runtime
      external: [
        "node:fs",
        "node:path",
        "node:child_process",
