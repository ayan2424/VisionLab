...
CONF_FILE="/www/server/panel/vhost/nginx/testide.ayan24.me.conf"
...
cat << "EOF" >> $CONF_FILE
    ...
    location /.well-known{
        allow all;
        root /www/wwwroot/testide.ayan24.me;
    }
    ...
    #LOG START
    access_log  /www/wwwlogs/testide.ayan24.me.log;
    error_log  /www/wwwlogs/testide.ayan24.me.error.log;
    #LOG END
}
EOF
