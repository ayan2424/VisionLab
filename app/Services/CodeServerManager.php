...
class CodeServerManager
{
    ...
    public function startWorkspace(Workspace $workspace): array
    {
        ...
        $cmd = [
            ...
            '--tmpfs', '/tmp',
            '--tmpfs', '/run',
            '--tmpfs', '/home/coder/.continue',
            '--tmpfs', '/home/coder/.config',
            '--tmpfs', '/home/coder/.local/share/code-server/User',
            '--tmpfs', '/home/coder/.local/share/code-server/logs',
            '--tmpfs', '/home/coder/.local/state',
            '--tmpfs', '/home/coder/.cache',
            '--tmpfs', '/home/coder/.npm',
