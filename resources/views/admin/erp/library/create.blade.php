...
<div class="max-w-3xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white mb-1">Add New Book</h1>
            <p class="text-slate-400 text-sm">Add a new book to the library catalog.</p>
        </div>
    </div>

    <form action="{{ route('admin.library.store') }}" method="POST" class="vc-card p-6 border-t-4" style="border-top-color:var(--vc-accent);">
        @csrf
        
        <div class="mb-6">
            <label class="block text-sm font-bold mb-2 text-slate-300">ISBN</label>
            <input type="text" name="isbn" value="{{ old('isbn') }}" class="vc-input w-full" placeholder="e.g. 978-3-16-148410-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" class="vc-input w-full" required placeholder="Book title">
            ...
            <div>
                ...
                <input type="text" name="author" value="{{ old('author') }}" class="vc-input w-full" required placeholder="Author name">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div>
                ...
                <input type="number" name="total_copies" value="{{ old('total_copies', 1) }}" class="vc-input w-full" required min="1">
            ...
            <div>
                ...
                <input type="number" name="available_copies" value="{{ old('available_copies', 1) }}" class="vc-input w-full" required min="0">
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="submit" class="btn-primary px-6 py-2.5 rounded-xl text-sm font-semibold shadow-lg">Save Book</button>
        </div>
    </form>
</div>
@endsection
