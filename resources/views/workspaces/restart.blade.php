...
<head>
    ...
    <title>Restarting {{ $workspace->name }} — VisionLab</title>
...
<div id="premium-loader">
    <div class="loader-box">
        <div class="loader-header">
            ...
            <div>
                <h3 class="loader-title">Restarting Workspace</h3>
                <p class="loader-subtitle">Please wait while we stop and start your container. Your files and configurations are safe.</p>
            </div>
        </div>
...
<script>
    ...
    // 1. Send the restart command
    fetch(`/workspace/${workspaceSlug}/restart/process`, {
        method: 'POST',
        headers: {
