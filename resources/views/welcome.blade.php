        ...
        <div class="grid items-stretch gap-6 lg:grid-cols-[1.05fr_1fr]">
            ...
            <div class="reveal">
                <div class="glass-panel relative h-[520px] overflow-hidden rounded-3xl md:h-[600px]">
                    ...
                    <div class="absolute bottom-0 right-0 z-10 h-16 w-44 bg-gradient-to-tl from-black via-black/80 to-transparent"></div>
...
(function initGlobeScene() {
    ...
    function isLand(lat, lon) {
        const centers = [
            ...
            { lat: 50, lon: 120, r: 25 },
            { lat: 35, lon: 105, r: 25 },
            { lat: 30, lon: 75, r: 15 }, // India
            { lat: 35, lon: 135, r: 10 }, // Japan
            { lat: 15, lon: 105, r: 12 }, // SE Asia
            // Australia
            { lat: -25, lon: 135, r: 20 },
            { lat: -30, lon: 140, r: 15 },
            // Greenland
    ...
    const hubs = [
        { name: "Silicon Valley", lat: 37.7749, lon: -122.4194, icon: "</>", color: "#17c3d6" },
        { name: "New York", lat: 40.7128, lon: -74.0060, icon: "js", color: "#f0426d" },
        { name: "London", lat: 51.5074, lon: -0.1278, icon: "ts", color: "#9b5de5" },
        { name: "Paris", lat: 48.8566, lon: 2.3522, icon: "py", color: "#17c3d6" },
        { name: "Berlin", lat: 52.5200, lon: 13.4050, icon: "rs", color: "#f0426d" },
        { name: "Bangalore", lat: 12.9716, lon: 77.5946, icon: "{}", color: "#9b5de5" },
        { name: "Tokyo", lat: 35.6762, lon: 139.6503, icon: "go", color: "#17c3d6" },
        { name: "Sydney", lat: -33.8688, lon: 151.2093, icon: "php", color: "#f0426d" },
        { name: "São Paulo", lat: -23.5505, lon: -46.6333, icon: "db", color: "#9b5de5" },
        { name: "Cape Town", lat: -33.9249, lon: 18.4241, icon: "git", color: "#17c3d6" },
        { name: "Singapore", lat: 1.3521, lon: 103.8198, icon: "ai", color: "#f0426d" },
        { name: "Toronto", lat: 43.6532, lon: -79.3832, icon: "c++", color: "#9b5de5" }
    ];
