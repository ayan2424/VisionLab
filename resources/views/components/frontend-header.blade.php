<nav id="mainNav" class="fixed inset-x-0 top-0 z-50 transition-all duration-500 border-b border-black/5 dark:border-white/5 bg-background/50 backdrop-blur-2xl">
    ...
    <div class="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <button class="hidden relative flex h-9 w-9 items-center justify-center rounded-full border border-black/10 dark:border-white/10 bg-black/[0.03] dark:bg-white/[0.03] text-muted-foreground transition-all hover:text-foreground">
